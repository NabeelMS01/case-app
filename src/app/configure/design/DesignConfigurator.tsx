...
const DesignConfigurator = ({
  ...
  function base64ToBlob(base64: string, mimeType: string) {
    const byteToCharacters = atob(base64);
    const byteNumbers = new Array(byteToCharacters.length);
    for (let i = 0; i < byteToCharacters.length; i++) {
      byteNumbers[i] = byteToCharacters.charCodeAt(i);
    }
  ...
  return (
    <div className="relative mt-20 grid grid-cols-3 max-[640px]:grid-cols-1 mb-20 pb-20">
      <div
        ref={containerRef}
      ...
      >
        ...
        <Rnd
          ...
          className="absolute z-20 borde-[3px] border-primary"
          lockAspectRatio
                      ...
                      {selectableOptions.map((option) => {
                        return (
                          <RadioGroup.Option
                            ...
                            className={({ active, checked }) =>
                              cn(
                                "relative block cursor-pointer rounded-lg bg-white mb-3 px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none sm:flex sm:justify-between",
                                {
