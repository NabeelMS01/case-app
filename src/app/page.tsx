        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-l lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture your favourite photo memories with your own,{" "}
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center">
                  <div className="flex gap-0.5">
                    <Star className="fill-green-600 text-green-600 h-4 w-4"></Star>
                    <Star className="fill-green-600 text-green-600 h-4 w-4"></Star>
                    <Star className="fill-green-600 text-green-600 h-4 w-4"></Star>
                    <Star className="fill-green-600 text-green-600 h-4 w-4"></Star>
                    <Star className="fill-green-600 text-green-600 h-4 w-4"></Star>
